      ...
      <div className='min-w-screen min-h-screen bg-slate-600'>
        ...
        <main className='grid grid-cols-1 lg:grid-cols-2 gap-6 py-6'>
          ...
          <div className='px-6 text-white space-y-6'>
            ...
            <div className='aspect-video bg-black m-10'>
            <iframe className='w-full h-full' src="https://www.youtube.com/embed/kLBtY_rneF0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
          </div>
